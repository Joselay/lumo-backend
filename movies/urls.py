...
urlpatterns = [
    ...
    path('seat-layouts/', views.SeatLayoutListView.as_view(), name='seat-layout-list'),
    ...
    path('showtimes/<uuid:pk>/seat-map/', views.ShowtimeSeatMapView.as_view(), name='showtime-seat-map'),
    path('showtimes/<uuid:showtime_id>/reserve-seats/', views.SeatReservationView.as_view(), name='reserve-seats'),
]